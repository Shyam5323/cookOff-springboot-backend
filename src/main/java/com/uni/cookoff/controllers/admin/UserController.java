...
public class UserController {
    ...
    @PostMapping("/ban")
    public ResponseEntity<?> banUser(@RequestBody List<String> request) {

        if (request.isEmpty()) {
            return ResponseEntity.badRequest().body("Request must not be empty");
        }
        for(String userId: request) {
            if (userId == null) {
    ...
    @PostMapping("/unban")
    public ResponseEntity<?> unbanUser(@RequestBody List<String> request) {
